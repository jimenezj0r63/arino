...
import {
    ...
    chevronForward,
    starOutline,
    pencilOutline, shieldOutline, imageOutline, mailOpenOutline, sendOutline
} from "ionicons/icons";
...
export default function Sidebar(){
    ...
    const [expandMenu, setExpandMenu] = useState({
        postMenu: !!route().current('admin.posts.*') || !!route().current('admin.categories.*') || !!route().current('admin.tags.*'),
        pageMenu: !!route().current('admin.pages.*'),
        appearanceMenu: !!route().current('admin.themes.*') || !!route().current('admin.menus.*'),
        ...
        userMenu: !!route().current('admin.users.*') || !!route().current('admin.roles.permissions.*'),
    });
    const handleToggle = () => {
                ...
                <div className="yoo-sidebarheader-in">
                    <div className="yoo-sidebar-nav">
                        <ul className="yoo-sidebar-nav-list yoo-mp0">
                            <li className={`yoo-sidebar-has-children ${route().current('admin.dashboard') && 'active'}`}>
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, postMenu: !expandMenu.postMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    ...
                                    <span className="yoo-sidebar-link-text">Posts</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.postMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('posts.index') && (
                                        <li className={`${route().current('admin.posts.index') && 'active'}`}>
                                            <Link href={route('admin.posts.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All posts</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('posts.create') && (
                                        <li className={`${route().current('admin.posts.create') && 'active'}`}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Add new</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('post_category.index') && (
                                        <li className={`${route().current('admin.categories.index') && 'active'}`}>
                                            <Link href={route('admin.categories.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Categories</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('post_tags.index') && (
                                        <li className={`${route().current('admin.tags.index') && 'active'}`}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Tags</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            {hasPermission('comments.index') && (
                                <li className={`yoo-sidebar-has-children ${route().current('admin.comments.*') && 'active'}`}>
                                    <Link href={route('admin.comments.index')}>
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-blue-bg">
                                      <IonIcon icon={chatboxOutline} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Comments</span>
                                  </span>
                                    </Link>
                                </li>
                            )}
                            {hasPermission('subscribers.index') && (
                                <li className={`yoo-sidebar-has-children ${route().current('admin.subscribers.*') && 'active'}`}>
                                    <Link href={route('admin.subscribers.index')}>
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-green-bg">
                                      <IonIcon icon={mailOpenOutline} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Subscribers</span>
                                  </span>
                                    </Link>
                                </li>
                            )}
                            {hasPermission('contacts.index') && (
                                <li className={`yoo-sidebar-has-children ${route().current('admin.contacts.*') && 'active'}`}>
                                    <Link href={route('admin.contacts.index')}>
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-red-bg">
                                      <IonIcon icon={sendOutline} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Contacts</span>
                                  </span>
                                    </Link>
                                </li>
                            )}
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, portfolioMenu: !expandMenu.portfolioMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-indigo-bg">
                                    ...
                                    <span className="yoo-sidebar-link-text">Portfolios</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.portfolioMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('portfolios.index') && (
                                        <li className={`${route().current('admin.portfolios.index') && 'active'}`}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Portfolio</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, serviceMenu: !expandMenu.serviceMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-indigo-bg">
                                    ...
                                    <span className="yoo-sidebar-link-text">Services</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.serviceMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('services.index') && (
                                        <li className={`${route().current('admin.services.index') && 'active'}`}>
                                            <Link href={route('admin.services.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Services</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, caseStudyMenu: !expandMenu.caseStudyMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-indigo-bg">
                                    ...
                                    <span className="yoo-sidebar-link-text">Case Study</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.caseStudyMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('case_study.index') && (
                                        <li className={`${route().current('admin.case.study.index') && 'active'}`}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Case Study</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, teamMenu: !expandMenu.teamMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-indigo-bg">
                                    ...
                                    <span className="yoo-sidebar-link-text">Teams</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.teamMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('teams.index') && (
                                        <li className={`${route().current('admin.teams.index') && 'active'}`}>
                                            <Link href={route('admin.teams.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Team Member</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, testimonialMenu: !expandMenu.testimonialMenu})}
                            >
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-indigo-bg">
                                    ...
                                    <span className="yoo-sidebar-link-text">Testimonials</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.testimonialMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('testimonials.index') && (
                                        <li className={`${route().current('admin.testimonials.index') && 'active'}`}>
                                            <Link href={route('admin.testimonials.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All testimonial</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('testimonials.create') && (
                                        <li className={`${route().current('admin.testimonials.create') && 'active'}`}>
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, pageMenu: !expandMenu.pageMenu})}>
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-orange-bg">
                                      <IonIcon icon={fileTray} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Pages</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.pageMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('pages.index') && (
                                        <li className={route().current('admin.pages.index') ? 'active': ''}>
                                            <Link href={route('admin.pages.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Pages</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('pages.create') && (
                                        <li>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Add New Page</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, appearanceMenu: !expandMenu.appearanceMenu})}>
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-gray-bg">
                                      <IonIcon icon={pencilOutline} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Appearance</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.appearanceMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('appearance.themes') && (
                                        <li className={route().current('admin.themes.index') ? 'active': ''}>
                                            <Link href={route('admin.themes.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Themes</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('appearance.customize') && (
                                        <li>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Customize</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('appearance.menus') && (
                                        <li className={route().current('admin.menus.index') ? 'active': ''}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Menus</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                            ...
                            <li className="yoo-sidebar-has-children"
                                onClick={() => setExpandMenu({...expandMenu, userMenu: !expandMenu.userMenu})}>
                                <a href="#">
                                  <span className="yoo-sidebar-link-title">
                                    <span className="yoo-sidebar-link-icon yoo-pink-bg">
                                      <IonIcon icon={peopleOutline} />
                                    </span>
                                    <span className="yoo-sidebar-link-text">Users</span>
                                  </span>
                                </a>
                                <ul className="yoo-sidebar-nav-dropdown" style={expandMenu.userMenu ? {display: 'block'} : {display: 'none'}}>
                                    {hasPermission('users.index') && (
                                        <li className={route().current('admin.users.index') ? 'active': ''}>
                                            <Link href={route('admin.users.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">All Users</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {hasPermission('users.create') && (
                                        <li className={route().current('admin.users.create') ? 'active': ''}>
                                          ...
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Add User</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
                                    {auth.user.role_name === "admin" && (
                                        <li className={route().current('admin.roles.permissions.index') ? 'active': ''}>
                                            <Link href={route('admin.roles.permissions.index')}>
                                          <span className="yoo-sidebar-link-title">
                                            <span className="yoo-sidebar-link-text">Role & Permission</span>
                                          </span>
                                            </Link>
                                        </li>
                                    )}
