...
export default function PricingTable({title, price, currency, features, btnLink, btnText, timeline, tab}) {
  return (
    <Div className="cs-pricing_table cs-style1">
      ...
      <Div className="cs-pricing_info">
        ...
        <Div className="cs-price_text">{`Per subscriber per ${tab === "monthly" ? "month" : "year"}`}</Div>
      </Div>
